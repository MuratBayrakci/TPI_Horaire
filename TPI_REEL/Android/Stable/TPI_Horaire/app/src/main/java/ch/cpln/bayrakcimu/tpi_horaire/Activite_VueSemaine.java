...
/*
                for(int i2=0;i2<19;i2++) {
                    String strHeureDebut = arrayPeriodes[i2];
                    String strHeure = strHeureDebut.substring(0, 2);
                    String strMinute = strHeureDebut.substring(3, 5);
                    int iMinute = 0;
                    int iHeure=0;
                    try {
                        iMinute = Integer.parseInt(strMinute);
                        iHeure = Integer.parseInt(strHeure);
                    } catch (Exception e) {
                    }
                    ...
                    for (int i = 0; i < 8; i++) {
                        if(iMinute==60){
                            iMinute=0;
                            iHeure = iHeure+1;
                            if(String.valueOf(iHeure).substring(0,1).equals("0")){   // si par exemple c0est 07 l'heure, bah parseint va le change en 7.

                                arrayPeriodeEntre[i2][i] = "0" + iHeure + "h0" + String.valueOf(iMinute);
                            }else{
                                arrayPeriodeEntre[i2][i] = iHeure + "h0" + String.valueOf(iMinute);
                            }

                        }else
                        {

                            if(String.valueOf(iMinute).substring(0,1).equals("0")){   // pareil
                                iMinute = iMinute + 5;
                                arrayPeriodeEntre[i2][i] = strHeure + "h0" + String.valueOf(iMinute);
                            }else{
                                iMinute = iMinute + 5;
                            arrayPeriodeEntre[i2][i] = strHeure + "h" + String.valueOf(iMinute);
                            }
                        }
                    }

                    Button btn = (Button) findViewById(R.id.BtnRechercher2);
                    btn.setText(strMinute);
                }
*/
    ...
    public void RemplissageCases(int iJour, int i100, int iNumll, String strHeureDebut, LinearLayout[][] llGeneral, String[] arrayPeriode, ArrayList<String>[] AlistHeureFin,
        ...
        if (Arrays.asList(libelleBranche).contains(AlistLibelle[iJour].get(i100))) {
            val2 = Arrays.asList(libelleBranche).indexOf(AlistLibelle[iJour].get(i100));
        } else {
            libelleBranche[val1] = AlistLibelle[iJour].get(i100);
            val1++;
            val2 = Arrays.asList(libelleBranche).indexOf(AlistLibelle[iJour].get(i100));
        }
        ...
        llGeneral[iJour][iNumeroll].setBackgroundColor(arrayCouleurs[val2]);
        int iIndex1 = 0;
        int iIndex2 = 0;
        int iIndexFinal = 0;
        iIndex1 = Arrays.asList(arrayPeriode).indexOf(strHeureDebut);
        String strHeureFin = AlistHeureFin[iJour].get(i100);
        iIndex2 = Arrays.asList(arrayPeriode).indexOf(strHeureFin);
        iIndexFinal = iIndex2 - iIndex1;
        tvLibelle[iJour][iNumeroll].setText(AlistCodeMatiere[iJour].get(i100));
        tvSalle[iJour][iNumeroll].setText(AlistSalle[iJour].get(i100));
        int iLength = AlistLibelle[iJour].get(i100).length();
        String strPartie1 = "";
        String strPartie2 = "";
        if (iLength > iNombreCharMax) {
            strPartie1 = AlistLibelle[iJour].get(i100).substring(0, iNombreCharMax);
            strPartie2 = AlistLibelle[iJour].get(i100).substring(iNombreCharMax);
        }

        for (int i = 1; i < iIndexFinal; i++) {
            llGeneral[iJour][iNumeroll + i].setBackgroundColor(arrayCouleurs[val2]);
        ...
        if (iIndexFinal == 2) {
            if (iLength > iNombreCharMax) {
                ...
                tvLibelle[iJour][iNumeroll + 1].setText(AlistSalle[iJour].get(i100));
                tvSalle[iJour][iNumeroll + 1].setText(AlistProf[iJour].get(i100));
            } else {
                tvLibelle[iJour][iNumeroll].setText(AlistLibelle[iJour].get(i100));
                tvLibelle[iJour][iNumeroll + 1].setText(AlistProf[iJour].get(i100));
            }
        }
        ...
        if (iIndexFinal == 3 || iIndexFinal == 4) {
            if (iLength > iNombreCharMax) {
                ...
                tvSalle[iJour][iNumeroll + 1].setText(AlistSalle[iJour].get(i100));
                tvLibelle[iJour][iNumeroll + 2].setText(AlistProf[iJour].get(i100));

            } else {
                tvLibelle[iJour][iNumeroll].setText("");
                tvSalle[iJour][iNumeroll].setText("");
                tvLibelle[iJour][iNumeroll + 1].setText(AlistLibelle[iJour].get(i100));
                tvSalle[iJour][iNumeroll + 1].setText(AlistSalle[iJour].get(i100));
                tvLibelle[iJour][iNumeroll + 2].setText(AlistProf[iJour].get(i100));
            }
        }
        if (iIndexFinal == 5) {
            if (iLength > iNombreCharMax) {
                ...
                tvSalle[iJour][iNumeroll + 2].setText(AlistSalle[iJour].get(i100));
                tvLibelle[iJour][iNumeroll + 3].setText(AlistProf[iJour].get(i100));
            } else {
                tvLibelle[iJour][iNumeroll].setText("");
                tvSalle[iJour][iNumeroll].setText("");
                tvLibelle[iJour][iNumeroll + 2].setText(AlistLibelle[iJour].get(i100));
                tvSalle[iJour][iNumeroll + 2].setText(AlistSalle[iJour].get(i100));
                tvLibelle[iJour][iNumeroll + 3].setText(AlistProf[iJour].get(i100));
            }
        }
...
//Fonction pour les périodes aux heures non conventionnelles.
    public void RemplissageCases2(int iJour, int i100, int iNumll,
        ...
        tvSalle[iJour][iNumll].setText(AlistCodeMatiere[iJour].get(i100));
        tvLibelle[iJour][iNumll+1].setText(AlistSalle[iJour].get(i100));
        tvSalle[iJour][iNumll].setBackgroundColor(arrayCouleurs[val2]);
        tvLibelle[iJour][iNumll+1].setBackgroundColor(arrayCouleurs[val2]);
